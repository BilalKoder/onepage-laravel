                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                        ...
                        <div class="home-title text-white text-center">
                            ...
                            <h1 class="display-4 letter-spacing mb-3 text-white font-weight-bold">A digital studio crafting beautiful experiences.</h1>
                            ...
                            <div class="subscribe-form mt-4 pt-4">
                                <form action="#" class="position-relative" style="max-width: 500px; margin: 0 auto;">
                                    <input name="email" id="email" type="email" class="rounded-pill" placeholder="example@mail.com">
                                ...
                                <div class="row">    
                                    <div class="col-lg-12 col-md-12 mt-4 pt-2">
                                        <div class="card work-desk rounded border-0 shadow-lg overflow-hidden">
                                            ...
                                            <a href="images/about/ab02.jpg" class="mfp-image">
                                                <div class="icon bg-primary text-center rounded-circle">
                                    ...
                                    <div class="col-12">
                                        <div class="mt-4 pt-2 text-right">
                                            <a href="javascript:void(0)" class="btn btn-primary">Read More <i data-feather="chevron-right" class="fea icon-sm"></i></a>
                                        </div>
                                    </div>
                                </div><!--end row-->
                            </div><!--end col-->
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="card work-desk rounded border-0 shadow-lg overflow-hidden">
                                            ...
                                            <a href="images/about/ab03.jpg" class="mfp-image">
                                                <div class="icon bg-primary shadow-lg text-center rounded-circle">
                                                    <i data-feather="plus" class="fea icons text-white icon-ex-md"></i>
                                                </div>
                                            </a>
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mt-4 pt-2">
                                    <div class="watch-video">
                                        <a href="http://vimeo.com/99025203" class="video-play-icon watch font-weight-bold title-dark text-dark"><i class="mdi mdi-play play-icon-circle text-center d-inline-block mr-2 rounded-circle text-white title-dark position-relative play play-iconbar"></i> Watch Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container mt-100 mt-60">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6">
                        <div class="mr-lg-5">
                            <img src="images/features/svg-1.svg" class="img-fluid" alt="">
                        </div>
                    </div><!--end col-->
            ...
            <div class="container mt-100 mt-60">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6 order-1 order-md-2">
                        <div class="ml-lg-5">
                            <img src="images/features/svg-4.svg" class="img-fluid" alt="">
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-6 col-md-6 order-2 order-md-1 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div class="section-title">
                            ...
                            <div class="mt-4">
                                <a href="javascript:void(0)" class="btn btn-primary">Learn More <i data-feather="chevron-right" class="fea icon-sm"></i></a>
                            </div>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
